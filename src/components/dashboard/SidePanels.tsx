...
// في وضع API الحقيقي: نعرض قوائم فارغة حتى يتم ربط مصادر البيانات الفعلية
const supervisors = USE_REAL_API ? [] : SUPERVISOR_PERFORMANCE;
const calls = USE_REAL_API ? [] : RECENT_CALLS;
const activities = USE_REAL_API ? [] : ACTIVITIES;
  ...
  return (
    <div className="glass-card p-5 anim-fade-in">
      ...
      {supervisors.length === 0 ? (
        <EmptyState text="لا توجد بيانات مشرفين بعد" />
      ) : (
